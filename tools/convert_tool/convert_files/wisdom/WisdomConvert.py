...
def main():
    ...
    file_wrong_snps = f'{tool_directory}/convert_files/wisdom/WisdomWrongAlleleInTranslationTable.txt'
    translation_table = f'{tool_directory}/convert_files/wisdom/WisdomTranslationTableUnchanged.txt'
