...
def main():
    ...
    filename_cf3_locations = f'{tool_directory}/convert_files/lupa170/LupaSNPsPresentInCF3.map'  # File with snps that have a location in canfam 3.1
    ...
    snps_not_in_top = f'{tool_directory}/convert_files/lupa170/Lupa174KSNPsNotInTop.list'  # File with SNPs that cannot be converted to TOP calling
